  ...
  run: async (client, message, args) => {
    ...
    let cape = args[0];
      ...
      return;
              ...
              if (fs.existsSync(`/var/www/html/cosmetic_list/hatsid/${cape}.png`)) {
                  fs.copyFile(`/var/www/html/cosmetic_list/hatsid/${cape}.png`, `/var/www/html/items/hat/users/${minecraftusers[message.author.id].nickname}.png`, (err) => {
                      if (err) throw err;
                  });
