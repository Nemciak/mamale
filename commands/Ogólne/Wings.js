...
module.exports = {
  config: {
    name: "wings",
    description: "Nadawanie skrzydel",
  },
  run: async (client, message, args) => {
    ...
    let cape = args[0];
      ...
      return;
              ...
              if (fs.existsSync(`/var/www/html/cosmetic_list/wingsid/${cape}.png`)) {
                  fs.copyFile(`/var/www/html/cosmetic_list/wingsid/${cape}.png`, `/var/www/html/items/wings/users/${minecraftusers[message.author.id].nickname}.png`, (err) => {
                      if (err) throw err;
                  });
